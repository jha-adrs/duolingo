  ...
  "inline-flex items-center justify-center whitespace-nowrap rounded-xl text-sm font-bold ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 uppercase tracking-wide",
  {
    variants: {
      variant: {
        ...
        primaryOutline: "bg-transparent text-sky-400 border-sky-400 border-2 border-b-4 active:border-b-[2px] hover:bg-slate-100",
        secondary: "bg-green-500 text-primary-foreground hover:bg-green-500/90 border-green-600 border-b-4 active:border-b-0",
        secondaryOutline: "bg-transparent text-green-500 border-green-500 border-2 border-b-4 active:border-b-[2px] hover:bg-slate-100",
        destructive: "bg-rose-500 text-primary-foreground hover:bg-rose-500/90 border-rose-600 border-b-4 active:border-b-0",
        destructiveOutline: "bg-transparent text-rose-500 border-rose-500 border-2 border-b-4 active:border-b-[2px] hover:bg-slate-100",
        super: "bg-indigo-500 text-primary-foreground hover:bg-indigo-500/90 border-indigo-600 border-b-4 active:border-b-0",
        superOutline: "bg-transparent text-indigo-500 border-indigo-500 border-2 border-b-4 active:border-b-[2px] hover:bg-slate-100",
        ghost: "bg-transparent text-slate-500 border-transparent border-2 border-b-4 active:border-b-0 hover:bg-slate-100",
        link: "bg-transparent text-sky-500 border-transparent border-2 border-b-4 active:border-b-0 hover:underline",
        sidebar: "bg-transparent text-slate-500 border-2 border-transparent hover:bg-slate-100 transition-none",
        sidebarOutline: "bg-sky-500/15 text-sky-500 border-sky-300 border-2 border-b-4 active:border-b-0 hover:bg-sky-500/20",
      },
      size: {
